  ...
  omni_target_priority_{ArmorPriority::fifth}
{
  ...
  fixed_low_armor_distance_ =
    yaml["fixed_low_armor_distance"].IsDefined() ? yaml["fixed_low_armor_distance"].as<double>()
                                                 : 0.0;
  fixed_high_armor_distance_ =
    yaml["fixed_high_armor_distance"].IsDefined() ? yaml["fixed_high_armor_distance"].as<double>()
                                                  : 0.0;
  fixed_height_diff_ =
    yaml["fixed_height_diff"].IsDefined() ? yaml["fixed_height_diff"].as<double>() : 0.0;
}
...
bool Tracker::set_target(std::list<Armor> & armors, std::chrono::steady_clock::time_point t)
{
  ...
  if (is_balance) {
    ...
    target_ = Target(
      armor, t, 0.2, 2, P0_dig, fixed_low_armor_distance_, fixed_high_armor_distance_,
      fixed_height_diff_);
  }
    ...
    target_ = Target(
      armor, t, 0.2765, 3, P0_dig, fixed_low_armor_distance_, fixed_high_armor_distance_,
      fixed_height_diff_);
  }
    ...
    target_ = Target(
      armor, t, 0.3205, 3, P0_dig, fixed_low_armor_distance_, fixed_high_armor_distance_,
      fixed_height_diff_);
  }
    ...
    Eigen::VectorXd P0_dig{{1, 64, 1, 64, 1, 64, 0.4, 100, 1, 1, 1}};
    target_ = Target(
      armor, t, 0.2, 4, P0_dig, fixed_low_armor_distance_, fixed_high_armor_distance_,
      fixed_height_diff_);
  }
